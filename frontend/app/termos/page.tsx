...
export const metadata: Metadata = {
  title: 'Termos de Uso',
  description: 'Termos e condições de uso dos serviços da Santuário Nerd, loja de card games em São José do Rio Preto, SP.',
}
      ...
      <main className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="space-y-10 leading-relaxed" style={{ color: "var(--text-muted)" }}>
          ...
          <section>
            ...
            <p>
              A <strong>Santuário Nerd</strong> é uma loja física de card games localizada em São José do Rio Preto, SP.
          ...
          <section>
            ...
            <p className="mt-2">
              ...
              <strong>Local:</strong> Santuário Nerd — São José do Rio Preto, SP
            </p>
          </section>
