...
// José Bonifácio, SP — Foro: Comarca de José Bonifácio
// =============================================================================
      ...
      <main className="max-w-3xl mx-auto px-4 py-12">
        ...
        <div className="mb-10 pb-6" style={{ borderBottom: '1px solid var(--border-color)' }}>
          ...
          <p className="text-sm" style={{ color: 'var(--text-faint)' }}>
            Última atualização: <strong>Junho de 2026</strong> — Versão 1.1
          </p>
          <p className="mt-3 leading-relaxed" style={{ color: 'var(--text-muted)' }}>
            Ao utilizar o sistema digital da <strong>Santuário Nerd</strong>, você concorda com os presentes
        ...
        <div className="space-y-10 leading-relaxed" style={{ color: 'var(--text-muted)' }}>
          ...
          <section>
            ...
            <p>
              A <strong>Santuário Nerd</strong> é uma loja física de card games localizada em <strong>José Bonifácio, SP</strong>.
          ...
          <section>
            ...
            <p>
              O crediário é uma linha de crédito oferecida pela Santuário Nerd a clientes cadastrados, sujeita
            ...
            <ul className="list-disc list-inside space-y-1 ml-2 mt-2">
              ...
              <li>A Santuário Nerd reserva-se o direito de negar o crediário a qualquer cliente</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-1 ml-2 mt-2">
              ...
              <li>A Santuário Nerd reserva-se o direito de alterar datas e regras de campeonatos com aviso prévio</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              e outros) são propriedade de seus respectivos detentores de direitos. A Santuário Nerd não reivindica
              qualquer direito sobre esses conteúdos.
            </p>
            <p className="mt-2">
              O sistema digital, o código-fonte e o design da plataforma Santuário Nerd são de propriedade
          ...
          <section>
            ...
            <p>
              ...
              <strong>Código de Defesa do Consumidor (Lei nº 8.078/1990)</strong>. Em caso de reclamação,
              você pode entrar em contato com a Santuário Nerd pelo e-mail{' '}
          ...
          <section>
            ...
            <p>
              ...
              <strong>Comarca de José Bonifácio, SP</strong>, com renúncia expressa a qualquer outro,
          ...
          <section>
            ...
            <p className="mt-2">
              ...
              <strong>Local:</strong> Santuário Nerd — José Bonifácio, SP
            </p>
          </section>
