...
export default function PWAInstallButton() {
  ...
  return (
    <div
      className={`js-pwa-install fixed bottom-5 right-5 z-50 flex items-center gap-2 bg-brand-600 text-white text-sm font-semibold pl-4 pr-2 py-2.5 rounded-2xl shadow-lg shadow-brand-900/25 transition-all duration-300 ${
