...
public class CrediariosController : ControllerBase
{
        ...
        Guid id, [FromBody] RegistrarPagamentoRequest request)
    {
        ...
        // A venda avulsa já validava a forma de pagamento contra PaymentMethod.All,
        // mas aqui qualquer string entrava e virava uma linha fantasma no relatório
        // financeiro agrupado por forma de pagamento.
