...
public class FiscalCertificadoService
{
    ...
    /// <summary>Mantido como atalho do que o serviço já expunha; a regra em si
    /// vive em <see cref="Cnpj"/>, compartilhada com a emissão.</summary>
    public static bool CnpjTemDigitoValido(string? cnpj) => Cnpj.EhValido(cnpj);
}
