...
namespace CardGameStore.Data.Migrations
{
    ...
    [Migration("20260908180306_AddSaleIdempotencyAndOpenCreditGuard")]
    partial class AddSaleIdempotencyAndOpenCreditGuard
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CardGameStore.Models.PostgreSQL.AiConfig", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("GeminiApiKeyEncrypted")
                        ...
                        .HasColumnName("gemini_api_key_encrypted");
            ...
            modelBuilder.Entity("CardGameStore.Models.PostgreSQL.Comanda", b =>
                {
                    ...
                    b.Property<int?>("CashReceivedInCents")
                        .HasColumnType("integer")
                        .HasColumnName("cash_received_in_cents");

                    b.Property<int>("CashRoundingDiscountInCents")
                        .HasColumnType("integer")
                        .HasColumnName("cash_rounding_discount_in_cents");

                    b.Property<int>("CashbackDebitedAtSale")
                        .HasColumnType("integer")
                        .HasColumnName("cashback_debited_at_sale");

                    b.Property<int>("ChangeInCents")
                        .HasColumnType("integer")
                        .HasColumnName("change_in_cents");
            ...
            modelBuilder.Entity("CardGameStore.Models.PostgreSQL.ComandaItem", b =>
                {
                    ...
                    b.Property<Guid?>("ProductionAreaId")
                        .HasColumnType("uuid")
                        .HasColumnName("production_area_id");

                    b.Property<string>("ProductionAreaNameSnapshot")
                        .HasMaxLength(80)
                        .HasColumnType("character varying(80)")
                        .HasColumnName("production_area_name_snapshot");

                    b.Property<DateTime?>("ProductionReadyAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("production_ready_at");

                    b.Property<DateTime?>("ProductionServedAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("production_served_at");
                    ...
                    b.HasIndex("ProductionAreaId", "ProductionStatus", "AddedAt")
            ...
            modelBuilder.Entity("CardGameStore.Models.PostgreSQL.CrediarioEmailOutbox", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("crediario_email_outbox");
                });
            ...
            modelBuilder.Entity("CardGameStore.Models.PostgreSQL.FinancialConfig", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<decimal>("CardFeePercent")
                        .HasColumnType("numeric(7,4)")
                        .HasColumnName("card_fee_percent");

                    b.Property<decimal>("CommissionPercent")
                        .HasColumnType("numeric(7,4)")
                        .HasColumnName("commission_percent");

                    b.Property<decimal>("ExpectedDailyNetCash")
                        .HasColumnType("numeric(14,2)")
                        .HasColumnName("expected_daily_net_cash");

                    b.Property<decimal>("FreightPercent")
                        .HasColumnType("numeric(7,4)")
                        .HasColumnName("freight_percent");

                    b.Property<decimal>("MinimumCashReserve")
                        .HasColumnType("numeric(14,2)")
                        .HasColumnName("minimum_cash_reserve");
            ...
            modelBuilder.Entity("CardGameStore.Models.PostgreSQL.IbptTabelaEntry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<decimal>("PercentualEstadual")
                        .HasColumnType("numeric")
                        .HasColumnName("percentual_estadual");

                    b.Property<decimal>("PercentualFederal")
                        .HasColumnType("numeric")
                        .HasColumnName("percentual_federal");

                    b.Property<decimal>("PercentualMunicipal")
                        .HasColumnType("numeric")
                        .HasColumnName("percentual_municipal");
                    ...
                    b.HasIndex("Ncm", "Uf", "Importado")
                        .IsUnique()
                        .HasDatabaseName("ix_ibpt_tabela_ncm_uf_origem");

                    b.ToTable("ibpt_tabela");
                });
            ...
            modelBuilder.Entity("CardGameStore.Models.PostgreSQL.NotaFiscalEmitida", b =>
                {
                    ...
                    b.Property<string>("ExternalPayloadJson")
                        .HasColumnType("text")
                        .HasColumnName("external_payload_json");
                    ...
                    b.HasIndex("ExternalSource", "ExternalDocumentId")
                        .IsUnique()
            ...
            modelBuilder.Entity("CardGameStore.Models.PostgreSQL.Product", b =>
                {
                    ...
                    b.Property<Guid?>("RestaurantProductionAreaId")
                        .HasColumnType("uuid")
                        .HasColumnName("restaurant_production_area_id");
                    ...
                    b.HasIndex("RestaurantProductionAreaId");

                    b.HasIndex("IsActive", "ShowOnMarketplace", "Name")
            ...
            modelBuilder.Entity("CardGameStore.Models.PostgreSQL.RestaurantProductionArea", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("restaurant_production_areas");
                });

            modelBuilder.Entity("CardGameStore.Models.PostgreSQL.SefazDistributionState", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<int>("BloqueiosConsecutivos")
                        .HasColumnType("integer")
                        .HasColumnName("bloqueios_consecutivos");
                    ...
                    b.Property<DateTime?>("ConsultaPontualJanelaInicio")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("consulta_pontual_janela_inicio");

                    b.Property<int>("ConsultaPontualQuantidade")
                        .HasColumnType("integer")
                        .HasColumnName("consulta_pontual_quantidade");
                    ...
                    b.Property<DateTime?>("ProximaConsultaEm")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("proxima_consulta_em");

                    b.Property<DateTime?>("SyncLockAte")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("sync_lock_ate");

                    b.Property<Guid?>("SyncLockId")
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("CardGameStore.Models.PostgreSQL.User", b =>
                {
                    ...
                    b.HasIndex("IsActive", "Role", "CreatedAt")
            ...
            modelBuilder.Entity("CardGameStore.Models.PostgreSQL.ComandaItem", b =>
                {
                    ...
                    b.HasOne("CardGameStore.Models.PostgreSQL.RestaurantProductionArea", null)
                        .WithMany()
            ...
            modelBuilder.Entity("CardGameStore.Models.PostgreSQL.Product", b =>
                {
                    ...
                    b.HasOne("CardGameStore.Models.PostgreSQL.RestaurantProductionArea", null)
                        .WithMany()
                        .HasForeignKey("RestaurantProductionAreaId")
                        .OnDelete(DeleteBehavior.SetNull);
